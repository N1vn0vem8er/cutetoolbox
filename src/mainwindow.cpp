    ...
    , ui(new Ui::MainWindow)
{
    ...
    addMenuItem(tr("HTML"), dark ? QIcon(":/icons/htmlformatter_dark.svg") : QIcon(":/icons/htmlformatter_light.svg"), new HTMLFormatterWidget(ui->stackedWidget));
    addMenuItem(tr("C++"), dark ? QIcon(":/icons/cppformatter_dark.svg") : QIcon(":/icons/cppformatter_light.svg"), new CppFormatterWidget(ui->stackedWidget));
    addMenuItem(tr("CSharp"), dark ? QIcon(":/icons/csharpformatter_dark.svg") : QIcon(":/icons/csharpformatter_light.svg"), new CSharpFormatterWidget(ui->stackedWidget));
    ...
    addMenuItem(tr("Desktop Creator"), dark ? QIcon(":/icons/desktop_dark.svg") : QIcon(":/icons/desktop_light.svg"), new DesktopCreatorWidget(ui->stackedWidget));
    ...
    addMenuItem(tr("Api Tester"), dark ? QIcon(":/icons/cloud_dark.svg") : QIcon(":/icons/cloud_light.svg"), new ApiTesterWidget(ui->stackedWidget));
