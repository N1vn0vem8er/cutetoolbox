    ...
    , ui(new Ui::ProtoFormatterWidget)
{
    ...
    int size = settings.beginReadArray("protoformatter.recentFiles");
...
ProtoFormatterWidget::~ProtoFormatterWidget()
{
    ...
    settings.beginWriteArray("protoformatter.recentFiles");
...
void ProtoFormatterWidget::openFile(const QString &path)
{
    QFile file(path);
...
void ProtoFormatterWidget::close()
{
    openedFile.clear();
    emit opened(openedFile);
}
...
QStringList ProtoFormatterWidget::getRecentFiles() const
{
    return recentFiles;
}

void ProtoFormatterWidget::openFromRecent(const QString &path)
{
...
void ProtoFormatterWidget::clearRecent()
{
    recentFiles.clear();
    emit updateRecent();
}
